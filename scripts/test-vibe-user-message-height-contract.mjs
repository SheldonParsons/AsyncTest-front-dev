...
assert.match(compiledStyle.code, /\.vibe-shell \.user-message-bubble \.user-message-content::selection\s*,\s*\.vibe-shell \.user-message-bubble \.user-message-content \*::selection\s*\{/)
assert.match(compiledStyle.code, /\.vibe-shell \.user-message-bubble \.user-message-content::-moz-selection\s*,\s*\.vibe-shell \.user-message-bubble \.user-message-content \*::-moz-selection\s*\{/)
...
assert.match(viewSource, /class="user-message-content user-message-markdown"\s+v-html="renderMarkdown\(userMessageText\(event\)\)"/)
assert.match(viewSource, /class="user-message-content user-message-markdown"\s+v-html="renderMarkdown\(pendingUserSubmissionText\)"/)
...
assert.match(viewSource, /:global\(\.vibe-shell \.user-message-bubble \.user-message-content::selection\),\s*\n:global\(\.vibe-shell \.user-message-bubble \.user-message-content \*::selection\)\s*\{[\s\S]*?background-color:\s*rgba\(148,\s*148,\s*148,\s*0\.72\)\s*!important;[\s\S]*?color:\s*#fff\s*!important;[\s\S]*?\}/)
assert.match(viewSource, /:global\(\.vibe-shell \.user-message-bubble \.user-message-content::-moz-selection\),\s*\n:global\(\.vibe-shell \.user-message-bubble \.user-message-content \*::-moz-selection\)\s*\{[\s\S]*?background-color:\s*rgba\(148,\s*148,\s*148,\s*0\.72\)\s*!important;[\s\S]*?color:\s*#fff\s*!important;[\s\S]*?\}/)
assert.match(viewSource, /\.user-message-bubble \.user-message-markdown\s*\{[\s\S]*:deep\(h1\)[\s\S]*:deep\(ul\)[\s\S]*:deep\(code\)/)
