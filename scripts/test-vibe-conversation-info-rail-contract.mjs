...
assert.match(railSource, /flex:\s*0 0 var\(--conversation-info-rail-width,\s*324px\)/)
...
assert.match(railSource, /:class="\{ collapsed, floating, returning \}"/)
assert.match(railSource, /\.conversation-info-rail\.floating\s*\{[^}]*position:\s*absolute;[^}]*right:\s*calc\(var\(--workspace-window-width\) \+ var\(--conversation-info-rail-gutter,\s*10px\)\);[^}]*flex:\s*none;/)
assert.match(railSource, /width:\s*min\([\s\S]*var\(--conversation-info-rail-width,\s*324px\),[\s\S]*100% - var\(--workspace-window-width\)/)
assert.match(railSource, /\.conversation-info-rail\.floating\.returning\s*\{[^}]*right:\s*var\(--conversation-info-rail-gutter,\s*10px\);/)
