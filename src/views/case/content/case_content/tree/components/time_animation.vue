...
<template>
    ...
    initial="hidden" animate="visible" class="case-drag-handle">
        <motion.path :variants="draw" :custom="0" :style="shape"  stroke="#9E9E9E" fill="#9E9E9E" d="M12 6v6H8" />
        <motion.circle :variants="draw" :custom="0" :style="shape"  stroke="#9E9E9E" fill="#9E9E9E" cx="12" cy="12" r="10" />
    </motion.svg>
</template>
