...
<template>
    ...
    initial="hidden" animate="visible" class="case-drag-handle">
        <motion.ellipse :variants="draw" :custom="0" :style="shape"  stroke="#4A90E2" fill="#4A90E2" cx="12" cy="5" rx="9" ry="3" />
        <motion.path :variants="draw" :custom="0" :style="shape"  stroke="#4A90E2" fill="#4A90E2" d="M3 5V19A9 3 0 0 0 21 19V5" />
        <motion.path :variants="draw" :custom="0" :style="shape"  stroke="#4A90E2" fill="#4A90E2" d="M3 12A9 3 0 0 0 21 12" />
    </motion.svg>
</template>
