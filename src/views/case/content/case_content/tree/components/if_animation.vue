...
<template>
    ...
    initial="hidden" animate="visible" class="case-drag-handle">
        <motion.path :variants="draw" :custom="2" :style="shape"  stroke="#e9546b" fill="#e9546b" d="M16 3h5v5" />
        <motion.path :variants="draw" :custom="0" :style="shape"  stroke="#0095d9" fill="#0095d9" d="M8 3H3v5" />
        <motion.path :variants="draw" :custom="0" :style="shape"  stroke="#0095d9" fill="#0095d9" d="M12 22v-8.3a4 4 0 0 0-1.172-2.872L3 3" />
        <motion.path :variants="draw" :custom="2" :style="shape"  stroke="#e9546b" fill="#e9546b" d="m15 9 6-6" />
    </motion.svg>
</template>
