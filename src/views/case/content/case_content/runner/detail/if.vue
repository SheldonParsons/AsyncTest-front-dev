    ...
    <div class="step-info">
        <div class="step-container">
            ...
            <div class="step-item">
                <div>条件判断模式</div>
                <div>
                    <Radio v-model="data.if_mode" :items="assertMode"></Radio>
                </div>
            </div>
            <div class="step-item" v-if="data.if_mode === 'fast'">
            ...
            <div class="step-item" style="width: 100%;" v-if="data.if_mode === 'script'">
                <MarkDown :data="ifScriptDemo"></MarkDown>
            </div>
            <div class="step-item" style="width: 100%;" v-if="data.if_mode === 'script'">
...
import { assertMode, patternMode, ifScriptDemo } from '@/views/case/utils/constants'
