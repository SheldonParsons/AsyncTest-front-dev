<template>
    <div class="dialog-container">
        <motion.div class="step-modal-container" :initial="dialogInitialState" :animate="dialogOpenState"
            :exit="dialogInitialState" :style="{ transformPerspective: 200 }">
                ...
                <div class="steps-container">
                    <motion.div class="b-item">
                        <motion.li class="guide-item" v-for="(item, index) in steps" :key="index"
                            ...
                            :whileHover="{ scale: 1.05 }" @hoverStart="onHoverStart(index)" @hoverEnd="hover_item = -1"
                            @click="action(item)">
                            ...
                            <Cursor :show="hover_item === index" follow
                                :offset="index < 5 ? { x: 10, y: 10 } : { x: 10, y: -150 }" :variants="{
                                    default: {
                                    ...
                                    <div class="step-detail-item">
                                        ...
                                        <div class="content" v-show="item === 'interface'">
                                            ...
                                            <div
                                                ...
                                                <Redo style="width: 1.5rem;color: #53727d;"></Redo>
                                            </div>
                                            <div class="interface"><span class="gradient-text gray">GET</span></div>
                                        </div>
                                    </div>
                                </motion.div>
                            </Cursor>
...
.orange {
    // color: #eead0e;
    background: linear-gradient(80deg, rgb(255, 255, 255) 0%, #976b49 80%);
}
