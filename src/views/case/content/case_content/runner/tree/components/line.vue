<template>
    <motion.div>
        <motion.div class="inner-line"></motion.div>
    </motion.div>
</template>
...
/* 没有 .hidden 时，开启闪烁动画 */
.target-line-top:not(.hidden),
.target-line-button:not(.hidden) {
    visibility: visible;
    /* 一旦可见，就用无限循环的 blinkLine 动画 */
...
.inner-line {
    height: 3px;
    border-radius: 10px;
    background: #fc29;  /* fallback for old browsers */     
