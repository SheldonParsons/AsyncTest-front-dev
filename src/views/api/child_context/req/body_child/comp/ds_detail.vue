            ...
            <DropdownMenu.Portal>
                <AnimatePresence>
                    <DropdownMenu.Content v-if="open" :side-offset="10" style="z-index: 9999;" side="bottom">
                        <div style="background-color: white;width: 900px;max-height: 350px;overflow-y: auto;border-bottom: 1px solid #f0f0f0;">
                            <ObjectTable :tableData="dsData" :canRootDs="false" :can_show_ds_detail="false"></ObjectTable>
                        </div>
...
import { ApiGetDsingle } from '@/api/ds/index'
