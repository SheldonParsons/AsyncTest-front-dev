<template>
    <div class="hold-container">
        <div class="button-wrapper">
            <motion.button class="button" :style="{
                scale: buttonScale,
            }" @pointerdown="handlePointerDown" @pointerup="handlePointerUp" @pointerleave="handlePointerUp">
                <motion.div class="button-background" :style="{
                    x: buttonProgressX,
                }" />
                Delete
            </motion.button>

            <motion.svg class="progress-ring" width="80" height="80" viewBox="0 0 320 320">
                <motion.circle cx="160" cy="160" r="120" fill="none" stroke="var(--white-feint)" stroke-width="24"
...
const circleColor = useTransform(progress, [0, 1], ["#ffffff", "#f73859"])
