<template>
  ...
  >
    ...
    <DataBase ref="filesPageRef" @changeDatabase="changeDatabaseHandle"></DataBase>
    <template #footer>
...
import { ref } from "vue";
import DataBase from "@/views/settings/source_management/database.vue"
const filesPageRef: any = ref(null);
const emit = defineEmits(["update:modelValue", "changeDatabase"]);
