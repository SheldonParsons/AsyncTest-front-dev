<template>
  <div class="grid-item">
    <div class="read-dynamic-value w-equal">
      <el-row style="width: 100%">
        <el-col :span="5"><Equal></Equal></el-col>
        <el-col
          :span="17"
...
.grid-item {
  ...
  .w-med {
    background-color: rgba(3, 13, 158, 0.04);
    border-color: rgba(3, 21, 158, 0.04);
    h1 {
      color: #2e3bcc;
    }
  }
  ...
  .w-med:hover {
    background-color: rgba(3, 24, 158, 0.08);
  }
  .w-var:hover {
