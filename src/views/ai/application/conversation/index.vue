<template>
  ...
  >
    ...
    <el-row style="width: 100%">
      <el-col>
        <div>
          <el-row class="sending" style="width: 100%">
            <el-col :offset="5" :span="14">
              <div class="input-main">
                ...
                <el-row style="margin-right: 10px; padding-bottom: 10px">
  ...
  <div class="chat">
    <el-row class="chat-content">
      <el-col :span="20" :offset="2">
        <div class="content-div top-content">
          <el-row
              ...
              <div>
                <div
                  style="
                    ...
                    white-space: normal;
                  "
                  v-html="getStandardContent(item.content)"
                ></div>
              </div>
            </el-col>
    ...
    <div class="send-div" v-if="talkingList.length > 0">
      <el-row class="sending">
        <el-col :offset="3" :span="14" class="flex-core">
          <div class="input-main">
            <el-row>
              <el-col :span="24">
                <el-input
  ...
  <div v-show="false" id="target-component">
    <el-row style="margin-bottom: 15px; margin-right: 10px">
      ...
      <el-col :span="4" style="display: flex; justify-content: end"
        ><el-button @click="copyText">Copy</el-button></el-col
      >
    </el-row>
    <p>被替换的内容</p>
  </div>
...
const current_app_id = ref(null);
const current_conversation_id = ref(null);
const current_project_id: any = ref(null);
      ...
      if (scroll_div.value.scrollTop === 0) {
        ...
        if (
          ...
          getConversation(
            ...
            current_position_index.value
          );
        }
      }
    });
    scrollToBottom(scroll_div.value);
  }, 0);
...
function getStandardContent(text: string) {
  return text.replace(/\n/g, "<br>");
}

function getConversation(id: number, index: any = null) {
  let data: any = {};
  if (index !== null) {
    data["position_index"] = index;
  }
  stop_message_scroll.value = false;
  current_conversation.value = id;
  getConversationSingle(id, data).then((res: any) => {
...
async function send(event: any) {
  ...
  try {
    ...
    scrollToBottom(scroll_div.value);
    current_project_id.value = route.params.project;
    await webApp(
