...
const storeName = Object.keys(asyncTest.rememberObjectStore)[0]

// 保存当前用户信息
export async function saveRememberStatus(state: any) {
...
// 获取当前user所有状态
export async function fetchRememberStatus() {
