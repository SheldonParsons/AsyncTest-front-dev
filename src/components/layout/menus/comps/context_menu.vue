                ...
                <AnimatePresence>
                    <ContextMenu.Content>
                        <motion.div class="context-menu-content" :initial="{ opacity: 0, scale: 0.9 }"
                            ...
                            <ContextMenu.Item class="context-menu-item" :disabled="data.child_type === 3" @select="menu_action(3, 'create_case_under_dir')">
                                添加用例
                                <div class="context-menu-shortcut">
                                    <InterfaceIcon></InterfaceIcon>
                                </div>
                            </ContextMenu.Item>
                            <ContextMenu.Item class="context-menu-item" :disabled="data.child_type === 3" @select="menu_action(4, 'create_child_dir')">
                                添加子目录
                                <div class="context-menu-shortcut">
                                    <FolderPlusIcon></FolderPlusIcon>
                                </div>
                            </ContextMenu.Item>
                            <ContextMenu.Item class="context-menu-item" :disabled="data.child_type === 0" @select="menu_action(2, 'copy_node')">
                                复制
                                <div class="context-menu-shortcut">
                                    <CopyIcon></CopyIcon>
                                </div>
                            ...
                            <ContextMenu.CheckboxItem class="context-menu-item" disabled style="display: flex;gap: 5px;"
                                v-model="bookmarksChecked">
                                <ContextMenu.ItemIndicator style="display: flex;justify-content: center;">
