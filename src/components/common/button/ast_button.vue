<template>
  <div>
    ...
    >
      <span><slot class="c-icon"></slot></span>
    </button>
    <button
      v-if="btnType === 3"
      :style="dynamicStyles"
    ...
    >
      <span>Click!</span><span><slot class="c-icon"></slot></span>
    </button>
    <button
      v-if="btnType === 12"
      :style="dynamicStyles"
...
.btn-13 {
  background-color: #89d8d3;
  background-image: linear-gradient(315deg, #33ac93 0%, #009879 74%);
  border: none;
  z-index: 1;
}
.btn-13:after {
  ...
  border-radius: 5px;
  background-color: #4dccc6;
  background-image: linear-gradient(315deg, #33ac93 0%, #009879 14%);
  box-shadow: -7px -7px 20px 0px #fff9, -4px -4px 5px 0px #fff9,
    7px 7px 20px 0px #0002, 4px 4px 5px 0px #0001;
  transition: all 0.3s ease;
}
